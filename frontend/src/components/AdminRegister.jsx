...
const AdminRegister = () => {
  ...
  const handleHospitalChange = (e, isFile = false) => {
      ...
      <div className="w-full md:w-1/2 flex justify-center items-center bg-white p-10">
        <div className="w-full max-w-xl bg-white p-10 rounded-xl shadow-lg">
                  ...
                  <form>
                    ...
                    <div className="relative mb-6">
                      <input
                        ...
                        name="logoUrl"
                        accept="image/*"
                        onChange={(e) => handleHospitalChange(e, true)}
                        className="w-full"
                      />

                      <label className="text-sm font-medium mt-1 block">
          ...
          <p className="text-center mt-4 text-sm">
            ...
            <Link to="/hms/auth" className="text-blue-500 hover:underline">
              Login
            </Link>
          </p>
        </div>
