    ...
    <div className="relative z-10 text-gray-700 bg-gray-50 p-4 rounded-xl">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <p>
          ...
          <span className="block text-sm sm:text-base">{doctor.qualification || "N/A"}</span>
        </p>
        <p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
        ...
        <p>
          <strong className="text-gray-500">Doctor Address:</strong>
          <span className="block text-sm sm:text-base">{doctor.address || "N/A"}</span>
        </p>
      </div>
    </div>
  );
        ...
        <div className="flex flex-col sm:flex-row items-center mb-4">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex items-center justify-center sm:justify-start space-x-2">
              ...
              <span className="bg-red-100 text-red-600 px-4 py-1 rounded-full text-xs sm:text-sm">
                {doctor.role}
              </span>
              {/* Work Type Label */}
