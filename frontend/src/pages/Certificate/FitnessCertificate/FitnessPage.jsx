  ...
  useEffect(() => {
    const fetchCertificates = async () => {
      try {
        ...
        // Filter only Fitness type certificates
        const fitnessCertificates = response.data.data.filter(
          cert => cert.type === "Fitness"
        );
        setCertificates(fitnessCertificates);
        setLoading(false);
      } catch (error) {
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-4 space-y-4 md:space-y-0">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-3 w-full md:w-auto">
          ...
          <button
            ...
            onClick={() => navigate(`/${role}/create-fitnesscertificate`)}
          >
                  ...
                  <td className="px-2 py-3">
                    <div className="flex space-x-2">
                      <button
                        ...
                        onClick={() => navigate(`/${role}/fitnesscertificate/${certificate._id}`)}
                      >
                        <FaEye />
                      </button>
                      <button
