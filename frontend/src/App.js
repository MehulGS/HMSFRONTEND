...
import ReceptionRoutes from "./components/Reception/ReceptionRoutes";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/hms/auth" element={isAuthenticated ? <Navigate to="/admin/dashboard" replace /> : <Login setIsAuthenticated={setIsAuthenticated} />} />
          ...
          element={
            isAuthenticated ? (
              <ProtectedRoute roles={["receptionist"]}>
                <BreadcrumbProvider>
                  <ReceptionRoutes onLogout={handleLogout} />
                </BreadcrumbProvider>
              </ProtectedRoute>
            ) : (
              <Navigate to="/hms/auth" replace />
